...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Follow', path: '/follows', entity: 'follow', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Like', path: '/likes', entity: 'like', service: AccessServiceEnum.PROJECT, icon: FiThumbsUp },
